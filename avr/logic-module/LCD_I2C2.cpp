...
void LCD_I2C2::scrollDisplayLeft()
{
    _output.rs = 0;
    _output.rw = 0;
...
// Part of Cursor or display shift
void LCD_I2C2::scrollDisplayRight()
{
    _output.rs = 0;
    _output.rw = 0;
...
// Set CGRAM address
void LCD_I2C2::createChar(uint8_t location, uint8_t charmap[])
{
    _output.rs = 0;
    _output.rw = 0;
...
// Set DDRAM address
void LCD_I2C2::setCursor(uint8_t col, uint8_t row)
{
...
size_t LCD_I2C2::write(uint8_t character)
{
    _output.rs = 1;
    _output.rw = 0;
...
void LCD_I2C2::I2C_Write(uint8_t output)
{
...
void LCD_I2C2::LCD_Write(uint8_t output, bool initialization)
{
    _output.data = output;
